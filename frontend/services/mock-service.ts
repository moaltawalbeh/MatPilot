...
export const projects: Project[] = [
  { id: "mp-024", name: "NMC-811 cathode study", description: "XRD phase identification", material: "LiNi₀.₈Mn₀.₁Co₀.₁O₂", owner_id: "demo", file_ids: [], job_ids: [], experiment_ids: [], status: "Active", tags: [], created_at: new Date().toISOString(), updated_at: new Date().toISOString(), files: 8, analyses: 3 },
  { id: "mp-023", name: "Perovskite stability screen", description: "Stability analysis", material: "BaTiO₃", owner_id: "demo", file_ids: [], job_ids: [], experiment_ids: [], status: "Active", tags: [], created_at: new Date().toISOString(), updated_at: new Date().toISOString(), files: 14, analyses: 7 },
  { id: "mp-021", name: "TiO₂ phase comparison", description: "Phase comparison study", material: "TiO₂", owner_id: "demo", file_ids: [], job_ids: [], experiment_ids: [], status: "Complete", tags: [], created_at: new Date().toISOString(), updated_at: new Date().toISOString(), files: 5, analyses: 2 },
];
